...
def sammon(x, n=2, display=2, inputdist='raw', maxhalves=20, maxiter=500,
           tolfun=1e-9, init='pca'):
    """
    ...
    xDinv[np.isinf(xDinv)] = 0  # Fix by replacing inf with 0 (default Matlab)
    ...
    yDinv[np.isinf(yDinv)] = 0  # Fix by replacing inf with 0 (default Matlab)
    ...
    for i in range(maxiter):
        ...
        for j in range(maxhalves):
            ...
            s_reshape = s.reshape(2, int(np.ceil(len(s)/2))).T
        ...
        if j == maxhalves:
            tmps = 'Warning: maxhalves exceeded. '
            tmps = 'Sammon mapping may not converge...'
            print(tmps)
