...
def plot_trellis_util(rake, strike, dip, depth, Z1, Z25, Vs30, region,
    ...
    pyplot.savefig(os.path.join(output_directory,'TrellisPlots_Vs30_'+str(
...
def plot_spectra_util(rake, strike, dip, depth, Z1, Z25, Vs30, region,
    ...
    fig2.savefig(os.path.join(output_directory,'sigma_Vs30_'+ str(Vs30)+'.png'),
                 bbox_inches='tight',dpi=200,pad_inches = 0.2)
    fig1.savefig(os.path.join(output_directory,'ResponseSpectra_Vs30_' + str(Vs30) +'.png'),
                 bbox_inches='tight',dpi=200,pad_inches = 0.2)
