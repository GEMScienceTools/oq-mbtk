...
def construct_sfs_dict(fault_dict, area_method='simple',
    ...
    # mfd
    calcmfd = calc_mfd_from_fault_params(fault_dict, area_method=area_method,
    ...
    sfs['seismic_slip_rate']=fault_dict['seismic_slip_rate']
    return sfs
...
def make_fault_source(sfs_dict, oqt_source=False):
    ...
    try:
        if oqt_source:
	        src = OQtSource(sfs_dict['source_id'], source_type='SimpleFaultSource') 
            ...
            src = SimpleFaultSource(*[sfs_dict[param] for param in sfs_params if param is not 'seismic_slip_rate'])
        return src
...
def calc_mfd_from_fault_params(fault_dict, area_method='simple',
    ...
    fault_dict['seismic_slip_rate'] = seismic_slip_rate
