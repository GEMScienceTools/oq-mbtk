...
def _print_legend(axes, depp, lnght):
    ...
    # MN: 'patches' assigned but never used
    patches = []
...
def plot(csda, depp, lnght):
    ...
    #
    # MN: 'ax0' assigned but never used
...
def main(argv):
    ...
    # MN: 'fig' imported but never used
