...
from openquake.man.checking_utils.plot_model_faults_utils import get_fault_geojsons


BASE_DATA_PATH = os.path.dirname(__file__)

EXP_POLYS_PATH = os.path.join(
    BASE_DATA_PATH, 'data_plot_model_faults_utils_test', 'expected', 'fault_sections.geojson')
...
class TestPlotFaults(unittest.TestCase):
    ...
    def test_get_fault_geoJSONs(self):
        ...
        """
        data_dir = os.path.join(BASE_DATA_PATH, 'data_plot_model_faults_utils_test')
