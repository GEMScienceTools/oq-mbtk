...
class AdaptiveSmoothingTestwkf(unittest.TestCase):
    ...
    def test_adap_smoothing_wkf(self):
        ...
        expected = np.array([1.85124547e-03, 2.32545463e-03, 9.81211408e-04, 2.59893514e-03,
       8.80487564e-04, 2.24894579e-03, 9.83247419e-04, 1.36002573e-03,
       1.76509281e-03, 9.73681917e-05, 4.30942107e-05, 1.29838234e-03,
       2.90803858e-03, 3.91305325e-06, 9.19557721e-04, 2.67332510e-03])
        # set up an expected
