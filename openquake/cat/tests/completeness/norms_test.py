...
from openquake.cat.completeness.norms import get_norm_optimize_b, get_norm_optimize_c, get_norm_optimize_poisson
...
class NormBTest(unittest.TestCase):
    ...
    def test_case02(self):
        ...
        norm = get_norm_optimize_c(cat, aval, bval, compl, 2022, ref_mag = rmag)
        print(f'{norm:.5e}')
